...
const About: NextPageWithLayout = () => {
    return (
        <Main title="About" className="container select-none">
            <div className="min-h-screen flex justify-center items-center">
                <div>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 pt-28">
                        <div className="relative flex justify-center items-center">
                            <Image src="/me.jpg" quality={100} className="object-cover rounded-full brightness-110" width="300" height="300" alt="Me" />
                        </div>

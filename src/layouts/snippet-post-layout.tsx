...
import { CalendarIcon, ChatAlt2Icon, EyeIcon, HeartIcon, XIcon } from '@heroicons/react/outline';

import { Link } from '@/components/link';
import { Textarea } from '@/components/textarea';
import { TableOfContents } from '@/components/snippets/table-of-contents';
...
type SnippetPostLayoutType = SnippetType

let grid = 'max-w-3xl mx-auto xl:max-w-none xl:grid xl:grid-cols-[1fr_50rem] xl:gap-x-8';

export const SnippetPostLayout: NextLayoutType<SnippetPostLayoutType> = ({ fm: { title, description, published }, children }) => {
                    ...
                    <article className={clsx('relative pt-0', grid)}>
                        ...
                        <div className="mb-12 mt-12 self-start text-sm leading-6 xl:sticky xl:top-[59px] xl:mt-0 xl:mb-0">
                            <div className="mb-5 py-5 hidden border-y border-slate-200 dark:border-slate-200/5 xl:flex xl:items-center">
                                <Link href="/snippets" className="group inline-flex items-center font-semibold text-slate-800 hover:text-slate-900 dark:text-slate-200 dark:hover:text-white">

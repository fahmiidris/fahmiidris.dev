...
One of my prominent responsibilities during the internship was enhancing the eFishery Internal Dashboard and FTS Tools App. Specifically, I worked on implementing a feature termed the "Expired Ticket," which automatically manages tickets older than 30 days. Both applications are web-based and are developed using React.js.

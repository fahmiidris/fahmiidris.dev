...
import ordent3 from './ordent-3.jpg';
...
export const meta = {
    ...
    images: [ordent1, ordent2, ordent3],
    date: {
        start: 1654534800000,
        end: 1682874000000,
    },
...
I work closely with **Project Managers**, **Backend Developers**, **UI/UX Designers**, and other **Frontend Developers**. I also had the opportunity to attend a meeting with the client to discuss a number of things.

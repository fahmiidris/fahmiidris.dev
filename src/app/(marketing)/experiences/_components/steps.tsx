                ...
                return (
                    <li
                        ...
                        className={clsxm(
                            ...
                            "before:absolute before:left-0 before:flex before:h-[calc(1.375rem+1px)] before:w-[calc(1.375rem+1px)] before:items-center before:justify-center before:text-[0.625rem] before:font-bold before:bg-cyan-100 before:text-slate-700 before:ring-1 before:ring-cyan-200 before:content-['']",

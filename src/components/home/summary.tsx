    ...
    <section id="summary" aria-labelledby="summary-title">
      <div className="container">
        <div className="mx-auto max-w-4xl text-left sm:text-center">
          <h2 id="reviews-title" className="text-4xl font-extrabold tracking-tight text-gray-800 sm:text-5xl">
          ...
          <figure>
            ...
            <figcaption className="mt-8 flex items-center justify-center space-x-4 text-left">
              <Image
                ...
                alt=""
                className="h-14 w-14 rounded-full ring-2 ring-cyan-400"
              />

              <div>
                <div className="font-semibold text-slate-800">Fahmi Idris</div>
                <div className="mt-0.5 text-sm leading-6">Frontend Developer at Ordent</div>
              </div>
            </figcaption>
          </figure>
        </div>

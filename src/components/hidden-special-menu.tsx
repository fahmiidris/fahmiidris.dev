    ...
    return (
        <div className="fixed left-4 bottom-4 z-50">
            <div className={clsx(
                ...
                <button type="button" onClick={() => setVisible(!visible)} className="inline-flex items-center justify-center rounded-md border border-transparent bg-slate-800 p-2 text-white focus:outline-none dark:bg-slate-800">
